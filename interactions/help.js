const { MessageEmbed , MessageActionRow , MessageButton } = require("discrord.js");
...
module.exports = {
  ...
  async interact(client,interaction) {
    ...
    .setColor("#454be9")
    .setDescription("You can have a total of 10 wallets per discord account . This will be done using the \`/config\` slash command .\nHowever , the overall portfolio will be based on all your wallets together ( you cannot have two portfolios splitting your wallets and such ) . Out of these 10 wallets , 2 will support `ETH + NFT(s)` and rest 8 will only support `ETH` . Adding a minimum of 1 wallet is necessary and you can further add upto 9 more !\n\n**Note:** Only the NFT(s) on ETHEREUM MAINNET are supported.");
